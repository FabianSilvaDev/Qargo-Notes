<div class="bg-gray-100 z-50 w-full h-full hidden items-center justify-center absolute" id="taskForm">
    <form action="{{ url('/') }}" method="post"
        class="flex flex-col items-center mt-4 bg-gray-100 p-6 rounded shadow-md max-w-[500px] w-full relative">
        ...
        <div class="flex gap-4">
            ...
            <button type="button" class="closeFormBtn bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 cursor-pointer">
                Cancel
            </button>
        </div>
    </form>
